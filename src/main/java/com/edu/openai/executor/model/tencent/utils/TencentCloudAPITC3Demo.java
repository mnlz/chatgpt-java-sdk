...
public class TencentCloudAPITC3Demo {
    ...
    private final static String SECRET_ID = "AKIDa6UlrqcFh3vb5fBYiicO1TnuoT5Xs36z";
    // 需要设置环境变量 TENCENTCLOUD_SECRET_KEY，值为示例的 Gu5t9xGARNpq86cd98joQYCN3*******
    private final static String SECRET_KEY = "ofcTOOOMTadaWKLF0c6Vr4B9yjeYO9lV";
